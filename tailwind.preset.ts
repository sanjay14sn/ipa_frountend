...
/**
 * PORT-02: the portable design-token preset — everything a future IPA app
 * copies alongside the marked `:root` token block in app/globals.css (the
 * two artifacts travel together; the preset only READS the CSS variables).
 *
 * App configs stay thin: `{ presets: [preset], content: [...], plugins: [app extras] }`.
 * See docs/design-system.md for the adoption recipe.
 */
