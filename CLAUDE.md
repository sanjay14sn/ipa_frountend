...
This project is indexed by GitNexus as **Abacus** (4995 symbols, 14797 relationships, 298 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
