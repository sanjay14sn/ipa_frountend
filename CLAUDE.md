...
This project is indexed by GitNexus as **Abacus** (7860 symbols, 16440 relationships, 284 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
