...
This project is indexed by GitNexus as **Abacus** (6973 symbols, 14462 relationships, 298 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
