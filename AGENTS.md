...
This project is indexed by GitNexus as **Abacus** (6160 symbols, 13185 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
