...
This project is indexed by GitNexus as **Abacus** (6136 symbols, 13077 relationships, 296 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
