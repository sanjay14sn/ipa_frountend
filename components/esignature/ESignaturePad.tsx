...
/* eslint-disable no-restricted-imports -- SW-P11 sanctioned raw-dialog exemption: the signature pad needs raw Dialog (canvas focus/pointer handling; no standard header/footer). */
import {
  Dialog,
  DialogContent,
  DialogDescription,
