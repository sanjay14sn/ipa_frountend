...
function CILoginPageInner() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // No CIAuthProvider here (this page lives in the lightweight (auth)
      // group) — the CI layout mounts a fresh provider that fetches /ci/me
      // on arrival, so no refresh() is needed before navigating.
      router.replace(
