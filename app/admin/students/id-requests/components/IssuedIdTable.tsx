...
import { RequestedIdDetailsByFranchise } from "@/services/student.service";
import StudentDetails from "./StudentDetails";

interface IssuedIdTableProps {
  data: RequestedIdDetailsByFranchise;
}

export default function IssuedIdTable({ data }: IssuedIdTableProps) {
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-secondary hover:bg-secondary">
              ...
              <TableHead className="text-center">Issued IDs</TableHead>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="text-sm text-gray-500">
                          {students.length} ID{students.length !== 1 ? "s" : ""}{" "}
                          issued
                        </div>
                      </div>
                    </div>
