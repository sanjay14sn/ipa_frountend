...
interface RequestedCertificateTableProps {
  data: RequestedCertificateDetailsByFranchise;
  onIssueCertificate: (student: RequestedCertificateDetail) => void;
}

export default function RequestedCertificateTable({
  data,
  onIssueCertificate,
}: RequestedCertificateTableProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-600">
        ...
        {totalStudents} requested certificates
      </div>
      ...
      {filteredData.length === 0 && (
        <div className="text-center py-8">
          <div className="text-gray-500">
            No requested certificates found matching your criteria
          </div>
        </div>
      )}
    </div>
