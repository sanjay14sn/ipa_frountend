...
export default function AdminOrdersTable() {
  ...
  // Hardcode status as PENDING for admin Orders page
  const statusFilter = OrderStatus.PENDING;
  ...
  return (
    <div className="space-y-4">
      ...
      <AdminTable
        ...
        // Status filter disabled; hardcoded to PENDING
        ...
        resultsText={(count, total) =>
          `Showing ${getTotalOrdersCount()} orders from ${count} franchises`
        }
      />
    </div>
  );
